# These functions help us generate the 2D Datasets where we fix time, demand or supply. In this case

import numpy as np

def price_fixed_time(pbase, psurge, supply, demand): # fixed pbase and psurge
